...
class DocumentVersion(Base):
    ...
    # LAN-M2: set only for a version promoted from a LAN source scan; NULL
    # for an ordinary HTTP upload. FK references source_entries.id by table
    # name only (SQLAlchemy ForeignKey doesn't require importing
    # app.sources.models here, same pattern documents already uses for
    # ForeignKey("knowledge_spaces.id") above).
